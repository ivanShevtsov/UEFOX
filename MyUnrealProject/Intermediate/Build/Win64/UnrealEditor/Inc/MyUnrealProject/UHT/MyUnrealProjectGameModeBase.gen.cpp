...
// End Cross Module References
	...
	AMyUnrealProjectGameModeBase::AMyUnrealProjectGameModeBase(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMyUnrealProjectGameModeBase);
	AMyUnrealProjectGameModeBase::~AMyUnrealProjectGameModeBase() {}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyUnrealProject_Source_MyUnrealProject_MyUnrealProjectGameModeBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMyUnrealProjectGameModeBase, AMyUnrealProjectGameModeBase::StaticClass, TEXT("AMyUnrealProjectGameModeBase"), &Z_Registration_Info_UClass_AMyUnrealProjectGameModeBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyUnrealProjectGameModeBase), 4086204077U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyUnrealProject_Source_MyUnrealProject_MyUnrealProjectGameModeBase_h_1527309178(TEXT("/Script/MyUnrealProject"),
